HAI 1.4
 ...
 HOW IZ I runninProgram YR programData
  ...
  IM IN YR loop UPPIN YR instructionCount TIL DIFFRINT 0 AN SMALLR OF 0 AN currentPosition BTW terminate when currentPosition < 0
   currentPosition R I IZ runninCommand YR programData AN YR currentPosition MKAY
  IM OUTTA YR loop
 IF U SAY SO
 ...
 TLDR
 HOW IZ I runninCommand YR programData AN YR currentPosition
  ...
  opcode, WTF?
   ...
   OMG 3
    FOUND YR I IZ runninInputCommand YR programData AN YR command AN YR currentPosition MKAY
   OMG 4
    FOUND YR I IZ runninOutputCommand YR programData AN YR command AN YR currentPosition MKAY
   OMG 5
   OMG 6
 ...
 HOW IZ I runninInputCommand YR programData AN YR command AN YR currentPosition
  I HAS A input
 ...
 HOW IZ I runninOutputCommand YR programData AN YR command AN YR currentPosition
